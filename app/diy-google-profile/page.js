...
export const metadata = {
  title: 'DIY Google Business Profile',
  description:
  ...
  alternates: { canonical: '/diy-google-profile' },
  openGraph: {
    title: 'DIY Google Business Profile — LocalFirst',
    description:
      "The 5 things you have to do every week to keep your Google Business Profile visible to AI. Plus Google's official 2026 playbooks, free.",
    url: '/diy-google-profile',
    type: 'article',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'DIY Google Business Profile',
    description: 'The 5 things you have to do every week. Plus free 2026 playbooks.',
  },
};
